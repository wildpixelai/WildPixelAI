...
export const metadata: Metadata = generatePageMetadata({
  title:       'Pricing — Personal, Commercial & Premium Licensing',
  description: 'Personal, Commercial, and Premium licensing tiers are currently being prepared. Browse free assets in the meantime.',
  path:        '/pricing',
...
export default function PricingPage() {
  ...
  return (
    <>
      <JsonLd schema={[
        webPageSchema({ title: `Pricing — ${SITE_NAME}`, path: '/pricing', description: 'Personal, Commercial, and Premium licensing for WildPixel creative assets.' }),
      ...
      <div className="mx-auto max-w-site px-6 md:px-8 lg:px-12 py-16 lg:py-24">
        <header className="text-center max-w-[600px] mx-auto mb-14">
          ...
          <p className="font-body text-body-lg text-text-secondary mt-4">
            Personal, Commercial, and Premium licensing tiers are currently being prepared.
          </p>
        </header>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1040px] mx-auto">
